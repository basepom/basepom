...
ifndef::release[]
== Current development version ({revnumber})

This is the current development documentation for the BasePOM project. All information in here reflects the current state of development on the `main` branch.
