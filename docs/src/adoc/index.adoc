...
* https://github.com/basepom/maven-plugins/[dependency-management] - validates that the versions in dependency management and plugin management match the resolved versions
* https://github.com/basepom/maven-plugins/[dependency-scope] - ensures that tests scoped dependencies do not override dependencies in compile scope
